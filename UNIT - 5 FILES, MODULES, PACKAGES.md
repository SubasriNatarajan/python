...
### DEMO CODE
Source.txt
![](D:\img\5.3 single line.png)
![](D:\img\5.3 single read line.png)
...
- If destination it opens and overwrites new contents if not it will creates new destination file
  ...
  ![](D:\img\5.4 write demo.png)

![](D:\img\5.4 write 2.png)
